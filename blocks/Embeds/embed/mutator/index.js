...
module.exports = new Classes.Mutator();
this.name = "embed_mutator";
this.blocks[require("./blocks/embed_mutator_author").type] = 1;
this.blocks[require("./blocks/embed_mutator_color").type] = 1;
this.blocks[require("./blocks/embed_mutator_description").type] = 1;
this.blocks[require("./blocks/embed_mutator_field").type] = 10;
this.blocks[require("./blocks/embed_mutator_footer").type] = 1;
this.blocks[require("./blocks/embed_mutator_image").type] = 1;
this.blocks[require("./blocks/embed_mutator_thumbnail").type] = 1;
this.blocks[require("./blocks/embed_mutator_timestamp").type] = 1;
this.blocks[require("./blocks/embed_mutator_title").type] = 1;
this.blocks[require("./blocks/embed_mutator_url").type] = 1;
