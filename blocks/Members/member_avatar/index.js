...
block.type = "member_avatar";
block.message0 = "get avatar url of member %1";
block.args0.push(
  new Classes.ArgValue("member", "Member"),
);
block.inputsInline = false;
block.output = "String";
block.tooltip = "Gets the avatar URL of a member.";
...
block.generator = function (Blockly, block) {
  return [Blockly.JavaScript.valueToCode(block, 'member', Blockly.JavaScript.ORDER_ATOMIC) + '.user.displayAvatarURL()', Blockly.JavaScript.ORDER_MEMBER];
}
