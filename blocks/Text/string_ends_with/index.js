...
block.type = "string_ends_with";
block.message0 = "%1 ends with %2";
block.args0.push(
...
block.tooltip = "Checks if a text ends with another text";
block.restrictions = [
...
block.generator = function (Blockly, block) {
  return [Blockly.JavaScript.valueToCode(block, 's_one', Blockly.JavaScript.ORDER_ATOMIC) + '.endsWith(' + Blockly.JavaScript.valueToCode(block, 's_two', Blockly.JavaScript.ORDER_ATOMIC) + ')', Blockly.JavaScript.ORDER_FUNCTION_CALL];
}
