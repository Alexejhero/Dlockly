...
block.type = "channel_type";
block.message0 = "get type of channel/category %1";
block.args0.push(
...
block.tooltip = "Gets the type of a channel.";
...
block.generator = function (Blockly, block) {
  return [Blockly.JavaScript.valueToCode(block, 'channel', Blockly.JavaScript.ORDER_ATOMIC) + '.type', Blockly.JavaScript.ORDER_MEMBER];
}
